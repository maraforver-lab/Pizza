  ...
  return (
    <main className="min-h-screen px-4 py-5 sm:px-6 sm:py-8">
      <div className="mx-auto max-w-4xl">
        <header className="flex items-center justify-between gap-4"><Link href={backHref} className="text-sm font-bold text-ink/60">← {t.back}</Link><div className="rounded-full bg-white px-3 py-2 text-xs font-bold text-ink/55 shadow-sm">{t.localTime} {timeFormatter.format(now)}</div></header>
