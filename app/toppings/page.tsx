...
export default function ToppingsPage() {
  ...
  const meterColor = result.load === "overloaded" || result.load === "heavy" ? "bg-tomato" : result.load === "balanced" ? "bg-leaf" : "bg-oven-gold";
