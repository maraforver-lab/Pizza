    ...
    <main className="min-h-screen overflow-hidden bg-[#f2e6d6] text-ink">
      ...
      >
        <Image
          ...
          priority
          sizes="100vw"
          className="absolute inset-0 -z-20 hidden object-cover object-center sm:block"
        />
        <Image
          ...
          priority
          sizes="100vw"
          className="absolute inset-0 -z-20 object-cover object-top sm:hidden"
        />
        <div className="absolute inset-0 -z-10 bg-[linear-gradient(90deg,rgba(246,238,224,0.98)_0%,rgba(246,238,224,0.88)_34%,rgba(246,238,224,0.25)_60%,rgba(246,238,224,0)_78%)] sm:block" />
        <div className="absolute inset-0 -z-10 bg-[linear-gradient(180deg,rgba(246,238,224,0.97)_0%,rgba(246,238,224,0.84)_34%,rgba(246,238,224,0.16)_63%,rgba(246,238,224,0.9)_100%)] sm:hidden" />
        ...
        <div className="mx-auto min-h-[calc(100vh-8rem)] w-full max-w-[92rem]">
          ...
          <div className="mt-[34vh] sm:mt-12 lg:absolute lg:right-12 lg:top-12 lg:mt-0 lg:w-[34rem] xl:right-20">
