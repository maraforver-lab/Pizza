...
describe("homepage active Pizza Session resume", () => {
  ...
  it("keeps homepage mobile and desktop actions on one shared resolver and confirmation contract", () => {
    ...
    expect(actions).toContain("Checking your pizza plan");
    expect(actions).toContain("hasActiveSession && !showChecking");
    expect(actions).toContain("Continue your pizza plan");
    expect(actions).toContain("Plan a pizza");
    expect(actions).toContain("Plan a new pizza");
    expect(actions).toContain("Plan a new pizza?");
    expect(actions).toContain("Keep current pizza plan");
    expect(actions).toContain("Set up a new pizza plan");
