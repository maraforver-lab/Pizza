    ...
    <main className="min-h-screen overflow-x-hidden bg-cream px-4 py-6 pb-24 text-ink sm:px-6 sm:py-10">
      <div className="mx-auto w-full max-w-4xl">
        ...
        <div className="mt-5 sm:mt-6">
          {showDeletionCompletion && accountDeleted ? (
            <section className="rounded-[1.75rem] border border-leaf/15 bg-white/80 p-4 shadow-sm sm:p-5" role="status">
              ...
              <Link
                href="/"
                className="mt-4 inline-flex min-h-11 w-full max-w-full items-center justify-center rounded-2xl bg-tomato px-5 text-sm font-extrabold text-white transition hover:bg-forest focus:outline-none focus-visible:ring-2 focus-visible:ring-tomato focus-visible:ring-offset-2 focus-visible:ring-offset-cream sm:w-auto"
              >
                Go to Homepage
              </Link>
            </section>
